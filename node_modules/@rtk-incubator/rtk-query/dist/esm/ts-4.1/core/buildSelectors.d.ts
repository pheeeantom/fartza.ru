import { MutationSubState, QuerySubState, RootState as _RootState, RequestStatusFlags } from './apiState';
import { EndpointDefinitions, QueryDefinition, MutationDefinition, QueryArgFrom, TagTypesFrom, ReducerPathFrom } from '../endpointDefinitions';
import { InternalSerializeQueryArgs } from '../defaultSerializeQueryArgs';
export declare const skipSelector: unique symbol;
...
declare type QueryResultSelectorFactory<Definition extends QueryDefinition<any, any, any, any>, RootState> = (queryArg: QueryArgFrom<Definition> | typeof skipSelector) => (state: RootState) => QueryResultSelectorResult<Definition>;
...
declare type MutationResultSelectorFactory<Definition extends MutationDefinition<any, any, any, any>, RootState> = (requestId: string | typeof skipSelector) => (state: RootState) => MutationResultSelectorResult<Definition>;
...
export declare function buildSelectors<InternalQueryArgs, Definitions extends EndpointDefinitions, ReducerPath extends string>({ serializeQueryArgs, reducerPath, }: {
...
export {};
//# sourceMappingURL=buildSelectors.d.ts.map