...
function shallowEqual(objA, objB) {
  ...
  if (_typeof__default['default'](objA) !== 'object' || objA === null || _typeof__default['default'](objB) !== 'object' || objB === null) {
    return false;
  }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              config = _objectSpread$7(_objectSpread$7({}, baseFetchOptions), {}, {
                method: method,
                signal: signal,
                body: body
              }, rest);
...
function buildSelectors(_ref) {
  ...
  function withRequestFlags(substate) {
    return _objectSpread$5(_objectSpread$5({}, substate), getRequestStatusFlags(substate.status));
  }
...
function buildCreateApi() {
  ...
  return function baseCreateApi(options) {
    ...
    var optionsWithDefaults = _objectSpread$4(_objectSpread$4({
      reducerPath: 'api',
    ...
    function injectEndpoints(inject) {
      var evaluatedEndpoints = inject.endpoints({
        query: function query(x) {
          ...
          return _objectSpread$4(_objectSpread$4({}, x), {}, {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              context = {};
              queryApi = _objectSpread$3(_objectSpread$3({}, api), {}, {
                context: context
              });
...
function buildMiddleware(_ref) {
  ...
  function refetchQuery(querySubState, queryCacheKey) {
    ...
    return queryThunk(_objectSpread$1({
...
function ApiProvider(props) {
    const [store] = React__default['default'].useState(() => toolkit.configureStore({
        reducer: {
    ...
    return (React__default['default'].createElement(reactRedux.Provider, { store: store, context: props.context }, props.children));
}
...
var defaultMutationStateSelector = function defaultMutationStateSelector(currentState) {
  return currentState;
};

var defaultQueryStateSelector = function defaultQueryStateSelector(currentState, lastResult) {
  var _ref;

  // data is the last known good request result we have tracked - or if none has been tracked yet the last good result for the current args
  var data = (_ref = currentState.isSuccess ? currentState.data : lastResult === null || lastResult === void 0 ? void 0 : lastResult.data) !== null && _ref !== void 0 ? _ref : currentState.data; // isFetching = true any time a request is in flight

  var isFetching = currentState.isLoading; // isLoading = true only when loading while no data is present yet (initial load with no data in the cache)

  var isLoading = !data && isFetching; // isSuccess = true when data is present
...
var noPendingQueryStateSelector = function noPendingQueryStateSelector(currentState, lastResult) {
  var selected = defaultQueryStateSelector(currentState, lastResult);
...
function buildHooks(_ref2) {
  var api = _ref2.api,
      ...
      useDispatch = _ref2$moduleOptions.useDispatch,
      useSelector = _ref2$moduleOptions.useSelector;
  return {
  ...
  function buildQueryHooks(name) {
    var useQuerySubscription = function useQuerySubscription(arg) {
      ...
      var dispatch = useDispatch();
      var stableArg = useShallowStableValue(arg);
      ...
      React.useEffect(function () {
        return function () {
          ...
          (_promiseRef$current2 = promiseRef.current) === null || _promiseRef$current2 === void 0 ? void 0 : _promiseRef$current2.unsubscribe();
      ...
      return React.useMemo(function () {
        return {
          ...
          refetch: function refetch() {
            ...
            return void ((_promiseRef$current3 = promiseRef.current) === null || _promiseRef$current3 === void 0 ? void 0 : _promiseRef$current3.refetch());
          }
        };
      }, []);
    };
    ...
    var useLazyQuerySubscription = function useLazyQuerySubscription() {
      var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          refetchOnReconnect = _ref4.refetchOnReconnect,
          refetchOnFocus = _ref4.refetchOnFocus,
          _ref4$pollingInterval = _ref4.pollingInterval,
          pollingInterval = _ref4$pollingInterval === void 0 ? 0 : _ref4$pollingInterval;

      var initiate = api.endpoints[name].initiate;
      var dispatch = useDispatch();

      var _useState = React.useState(UNINITIALIZED_VALUE),
      ...
      React.useEffect(function () {
        ...
        if (stableSubscriptionOptions !== lastSubscriptionOptions) {
          ...
          (_promiseRef$current5 = promiseRef.current) === null || _promiseRef$current5 === void 0 ? void 0 : _promiseRef$current5.updateSubscriptionOptions(stableSubscriptionOptions);
        }
      ...
      var trigger = React.useCallback(function (arg) {
        var preferCacheValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        batch(function () {
          var _promiseRef$current6;

          (_promiseRef$current6 = promiseRef.current) === null || _promiseRef$current6 === void 0 ? void 0 : _promiseRef$current6.unsubscribe();
      ...
      React.useEffect(function () {
        return function () {
          ...
          promiseRef === null || promiseRef === void 0 ? void 0 : (_promiseRef$current7 = promiseRef.current) === null || _promiseRef$current7 === void 0 ? void 0 : _promiseRef$current7.unsubscribe();
        };
      }, []);
    ...
    var useQueryState = function useQueryState(arg) {
      var _ref5 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          ...
          skip = _ref5$skip === void 0 ? false : _ref5$skip,
          _ref5$selectFromResul = _ref5.selectFromResult,
          selectFromResult = _ref5$selectFromResul === void 0 ? defaultQueryStateSelector : _ref5$selectFromResul;

      var select = api.endpoints[name].select;
      var stableArg = useShallowStableValue(arg);
      var lastValue = React.useRef();
      var querySelector = React.useMemo(function () {
        return toolkit.createSelector([select(skip ? skipSelector : stableArg), function (_, lastResult) {
          return lastResult;
        }], function (subState, lastResult) {
          return selectFromResult(subState, lastResult, defaultQueryStateSelector);
        });
    ...
    return {
      ...
      useLazyQuery: function useLazyQuery(options) {
        var _useLazyQuerySubscrip = useLazyQuerySubscription(options),
            _useLazyQuerySubscrip2 = _slicedToArray__default['default'](_useLazyQuerySubscrip, 2),
      ...
      useQuery: function useQuery(arg, options) {
        ...
        var queryStateResults = useQueryState(arg, _objectSpread({
          selectFromResult: options !== null && options !== void 0 && options.skip ? undefined : noPendingQueryStateSelector
        }, options));
        return React.useMemo(function () {
  ...
  function buildMutationHook(name) {
    return function () {
      var _ref6 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          _ref6$selectFromResul = _ref6.selectFromResult,
          selectFromResult = _ref6$selectFromResul === void 0 ? defaultMutationStateSelector : _ref6$selectFromResul;
      ...
      var _useState3 = React.useState(),
          ...
          requestId = _useState4[0],
          setRequestId = _useState4[1];
      ...
      React.useEffect(function () {
        return function () {
          ...
          (_promiseRef$current8 = promiseRef.current) === null || _promiseRef$current8 === void 0 ? void 0 : _promiseRef$current8.unsubscribe();
          promiseRef.current = undefined;
        };
      }, []);
      var triggerMutation = React.useCallback(function (arg) {
        ...
        batch(function () {
          ...
          promiseRef === null || promiseRef === void 0 ? void 0 : (_promiseRef$current9 = promiseRef.current) === null || _promiseRef$current9 === void 0 ? void 0 : _promiseRef$current9.unsubscribe();
      ...
      var mutationSelector = React.useMemo(function () {
        return toolkit.createSelector([select(requestId || skipSelector)], function (subState) {
          return selectFromResult(subState, defaultMutationStateSelector);
        });
...
var reactHooksModule = function reactHooksModule() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      batch = _ref$batch === void 0 ? reactRedux.batch : _ref$batch,
      _ref$useDispatch = _ref.useDispatch,
      useDispatch = _ref$useDispatch === void 0 ? reactRedux.useDispatch : _ref$useDispatch,
      _ref$useSelector = _ref.useSelector,
      useSelector = _ref$useSelector === void 0 ? reactRedux.useSelector : _ref$useSelector,
      _ref$useStore = _ref.useStore,
      useStore = _ref$useStore === void 0 ? reactRedux.useStore : _ref$useStore;

  return {
    name: reactHooksModuleName,
    init: function init(api, options, context) {
      var anyApi = api;
